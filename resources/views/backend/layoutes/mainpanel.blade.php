...
<script>
  ...
  // Format the date like: "Today (25 Jul 2025)"
  const options = { day: '2-digit', month: 'short', year: 'numeric' };
  const formatted = today.toLocaleDateString('en-GB', options); // e.g., "25 Jul 2025"

  // Update the HTML
  document.getElementById("current-date").innerText = `Today (${formatted})`;
</script>
</div>
</div>
